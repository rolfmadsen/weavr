...
> [!IMPORTANT]
> **Weavr Compatibility**: Weavr is a **Local-First / P2P** application. Ignore patterns related to backend microservices, API gateways, or server-side scaling. Focus on logical boundaries and modularity within the client.
